...
public class TestForBulk05 {
    ...
    public void testData(){
        ...
        Session session7 = driver.session();
        //参数变量
        Map<String, Object> parameters = new HashMap<>();
        ...
        StatementResult result = session.run("" +
                "UNWIND {batches} as row\n" +
                "merge (n:base {accountId: row.accountId})\n" +
...
//        RETURN charlie
        ...
        System.out.println("==================================");
//
//        session2.run("CREATE (le:Person {name:\"Euler\"}),\n" +
...
//        System.out.println("++++++++++++++++++++++++++++++++++");
//
//        session3.run("MERGE (charlie:Person { name:'Charlie Sheen', age:10 })\n" +
//                "        RETURN charlie");
//
//        System.out.println("------------------------------------");
//
//        session4.run("MATCH (ee:Person) WHERE ee.name = \"Emil\"\n" +
...
//
//        session5.run("CREATE (TheMatrix:Movie {title:'The Matrix', released:1999, tagline:'Welcome to the Real World'})\n" +
...
//        session6.run("LOAD CSV WITH HEADERS FROM \"http://data.neo4j.com/northwind/products.csv\" AS row\n" +
//                "CREATE (n:Product)\n" +
//                "SET n = row,\n" +
...
//        session7.run("LOAD CSV WITH HEADERS FROM \"http://data.neo4j.com/northwind/categories.csv\" AS row\n" +
//                "CREATE (n:Category)\n" +
//                "SET n = row");
//        System.out.println("777777777777777777777777777777777777777777777777777777777777777777777777777777777777777");
       ...
       session.run("");
        ...
        System.out.println(resultSummary.counters().nodesCreated());
